...
//            this.printMaze(pSolution);
    ...
    public static void main (String[] args) {
        int[][] locSolution;
        RatMaze locRatMaze = new RatMaze();
        ...
        locSolution=locRatMaze.searchSolution(locInitialMaze, locSolutionMaze, locRatMaze.locStartPosY, locRatMaze.locStartPosY, globalFound);
        locRatMaze.printMaze(locInitialMaze);
        System.out.println(globalFound);
        locRatMaze.printMaze(locSolution);
